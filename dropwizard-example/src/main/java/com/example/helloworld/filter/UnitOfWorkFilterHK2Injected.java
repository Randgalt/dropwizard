...
@Provider
public class UnitOfWorkFilterHK2Injected implements ContainerRequestFilter, ContainerResponseFilter{
	private static final Logger logger = LoggerFactory.getLogger(UnitOfWorkFilterHK2Injected.class);
	
	@javax.inject.Inject
    private UnitOfWork unitOfWork;

    public UnitOfWorkFilterHK2Injected() {
